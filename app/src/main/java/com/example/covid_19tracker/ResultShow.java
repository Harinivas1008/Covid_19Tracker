    ...
    private void fetchData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (stringy.equals("[]")){
                                Toast.makeText(ResultShow.this, "There is No Vaccination ! Sorry", Toast.LENGTH_LONG).show();
                                //Here You can add any function you want , i only add here a Toast Message Only.
                                progressDialog.dismiss();
                            }

                            else {
                                myCustomAdapter = new myCustomAdapter(ResultShow.this,countryModelsList);
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(ResultShow.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
